...
GYMS = {
    ...
    'SteinbockErlangen': {
        ...
        're': r'<div class="freecounter-content"><span data-value="\d+">(\d+)</span></div>',
        'opening_hours': (
            ('09:00', '23:00'), ('09:00', '23:00'), ('09:00', '23:00'), ('09:00', '23:00'),
            ('09:00', '23:00'), ('09:00', '22:00'), ('09:00', '22:00'))
    },
    'BoulderWeltOst': {
        'url': 'https://www.boulderwelt-muenchen-ost.de/',
        're': r'crowd-level-pointer.*<noscript>.*calc\(.*\).*>([0-9]+)%.*crowd-level-tag',
        'percentage': True,
        'opening_hours': (
            ('07:00', '23:00'), ('07:00', '23:00'), ('07:00', '23:00'), ('07:00', '23:00'),
